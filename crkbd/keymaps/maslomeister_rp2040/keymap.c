...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        MIN_LAL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_SLASH,
    ...
    [_ADJUST] = LAYOUT_split_3x6_3(
        ...
        SCRCUT, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_NUM, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,

        KC_NO, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, KC_SCRL, KC_NO, RGB_VAI, RGB_SAI, RGB_HUI, RGB_TOG,
