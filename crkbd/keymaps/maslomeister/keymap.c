...
#define MIN_RAL MT(MOD_LALT, KC_MINUS)
#define BSL_LAL MT(MOD_LALT, KC_BSLS)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        RBR_LGU, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, LBR_RGU,

        GRV_LCT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, QUO_RCT,

        BSL_LAL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MIN_RAL,
    ...
    [_LOWER] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, KC_F1, KC_F2, KC_F3, KC_F4, CLRPCK, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_RGUI,

        KC_LCTL, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_RCTL,

        KC_LALT, KC_F9, KC_F10, KC_F11, KC_F12, LNG_SW, VSC, CHROME, TERMINAL, EXPLORER, KC_NO, KC_RALT,
    ...
    [_RAISE] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, KC_PAST, KC_7, KC_8, KC_9, KC_PPLS, KC_VOLU, KC_HOME, KC_MPLY, KC_PGUP, SCRCUT, KC_RGUI,
    ...
    [_ADJUST] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, KC_NO, KC_P7, KC_P8, KC_P9, KC_NLCK, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,

        KC_LCTL, KC_PENT, KC_P4, KC_P5, KC_P6, KC_SLCK, KC_NO, KC_NO, RGB_VAI, RGB_SAI, RGB_HUI, RGB_TOG,

        KC_LALT, KC_P0, KC_P1, KC_P2, KC_P3, KC_CAPS, KC_NO, KC_NO, RGB_VAD, RGB_SAD, RGB_HUD, RGB_MOD,
...
//     static const char PROGMEM gaming[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE0, 0xF0, 0xF0, 0xF0, 0xE0, 0xC0, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7E, 0x3C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x0F, 0x0F, 0x0F, 0x07, 0x03, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
//     oled_write_raw_P(gaming, 96);
// }

// void render_gaming_lower(void) {
//     static const char PROGMEM gaming_lower[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE0, 0xF0, 0xF0, 0xF0, 0xE0, 0xC0, 0x80, 0x00, 0x00, 0x00, 0x20, 0xDE, 0x20, 0x00, 0x08, 0xF6, 0x08, 0x00, 0x04, 0xFA, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7E, 0x3C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x0F, 0x0F, 0x0F, 0x07, 0x03, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
static void render_anim(void) {
    static const char PROGMEM idle[IDLE_FRAMES][ANIM_SIZE] = {{,
                                                              ...
                                                              {,
                                                               ...
                                                               }};
    // static const char PROGMEM prep[PREP_FRAMES][ANIM_SIZE] = {{,
    //                                                            ,
    //                                                            },
    //                                                           {,
    //                                                            ,
    //                                                            }};
    // static const char PROGMEM tap[TAP_FRAMES][ANIM_SIZE]   = {{,
    //                                                            ,
    //                                                            },
    //                                                           {,
    //                                                            ,
    //                                                            },
    //                                                           {,
    //                                                            ,
    //                                                            },
    //                                                           {,
    //                                                            ,
    //                                                            },
    //                                                           {,
    //                                                            ,
    //                                                            }};
