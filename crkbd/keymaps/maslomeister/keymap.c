...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        RBR_LGU, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRACKET,

        GRV_LCT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,

        MIN_LAL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_BSLASH,
    ...
    [_RAISE] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, KC_PAST, KC_7, KC_8, KC_9, KC_PPLS, KC_VOLU, KC_HOME, KC_MPLY, KC_PGUP, KC_NO, KC_RGUI,

        KC_LCTL, KC_PSLS, KC_4, KC_5, KC_6, KC_PMNS, KC_MUTE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_RCTL,

        KC_LA_EQL, KC_0, KC_1, KC_2, KC_3, KC_PDOT, KC_VOLD, KC_END, KC_NO, KC_PGDN, KC_NO, KC_RALT,
    ...
    [_ADJUST] = LAYOUT_split_3x6_3(
        ...
        SCRCUT, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_NLCK, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,

        KC_NO, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, KC_SLCK, KC_NO, RGB_VAI, RGB_SAI, RGB_HUI, RGB_TOG,

        KC_NO, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_CAPS, KC_NO, RGB_VAD, RGB_SAD, RGB_HUD, RGB_MOD,
