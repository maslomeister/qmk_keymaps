...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_split_3x6_3(
        ...
        KC_LALT, KC_F9, KC_F10, KC_F11, KC_F12, LNG_SW, KC_TRNS, CPRGHT, DEGREE, GRTSGN, PLSMNS, KC_RALT,
    ...
    [_RAISE] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, KC_PAST, KC_7, KC_8, KC_9, KC_PPLS, KC_VOLU, KC_HOME, KC_MPLY, KC_PGUP, KC_WH_U, KC_RGUI,

        KC_LCTL, KC_PSLS, KC_4, KC_5, KC_6, KC_PMNS, KC_MUTE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_RCTL,

        KC_LA_EQL, KC_0, KC_1, KC_2, KC_3, KC_PDOT, KC_VOLD, KC_END, SCRCUT, KC_PGDN, KC_WH_D, KC_RALT,
    ...
    [_ADJUST] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, RESET, KC_P7, KC_P8, KC_P9, KC_NLCK, KC_SLCK, KC_NO, KC_NO, KC_NO, KC_NO, RGBRST,

        KC_LCTL, KC_PENT, KC_P4, KC_P5, KC_P6, KC_NO, KC_PAUS, KC_NO, RGB_VAI, RGB_SAI, RGB_HUI, RGB_TOG,

        KC_LALT, KC_P0, KC_P1, KC_P2, KC_P3, KC_NO, KC_NO, KC_NO, RGB_VAD, RGB_SAD, RGB_HUD, RGB_MOD,
